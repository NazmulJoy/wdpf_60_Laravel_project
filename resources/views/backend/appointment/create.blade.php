                                    ...
                                    <div class="form-wrap">
                                        <form class="form-horizontal" action="{{route('frontappointment.store')}}" method="post">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-9">
                                                    <div class="input-group">
                                                        <input type="text" name="name" value="{{old('name')}}" class="form-control" id="exampleInputuname_4" placeholder="Name of patient">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-9">
                                                    <div class="input-group">
                                                        <input type="email" name="email" value="{{old('email')}}" class="form-control" id="exampleInputuname_4" placeholder="Email of patient">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-9">
                                                    <div class="input-group">
                                                        <input type="text" name="phone" value="{{old('phone')}}" class="form-control" id="exampleInputuname_4" placeholder="Phone of patient">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-9">
                                                    <div class="input-group">
                                                        <input type="text" name="remarks" value="{{old('remarks')}}" class="form-control" id="exampleInputuname_4" placeholder="Remarks of patient">
